...
internal class KitsuConverterTest {
    ...
    inner class AnimeTests {
            ...
            fun `title containing special chars`() {
                tempDirectory {
                    ...
                    val testKitsuConfig = object: MetaDataProviderConfig by MetaDataProviderTestConfig {
                        ...
                        override fun buildDataDownloadUrl(id: String): URL = KitsuConfig.buildDataDownloadUrl(id)
        ...
        inner class EpisodesTests {
            ...
            fun `episodes is null`() {
                tempDirectory {
                    ...
                    testResource("file_converter_tests/no_adaption_no_relations_default_file.json")
                            .copyTo(relationsDir.resolve("10104.${testKitsuConfig.fileSuffix()}"))

                    val tagsDir = tempDir.resolve("tags").createDirectory()

                    testResource("file_converter_tests/no_tags_default_file.json")
                        .copyTo(tagsDir.resolve("10104.${testKitsuConfig.fileSuffix()}"))
        ...
        inner class TypeTests {
            ...
            @Test
            fun `throw an exception in case there is a new unknown type`() {
                tempDirectory {
                    // given
                    val testKitsuConfig = object: MetaDataProviderConfig by MetaDataProviderTestConfig {
                        override fun buildAnimeLinkUrl(id: AnimeId): URL = KitsuConfig.buildAnimeLinkUrl(id)
        ...
        inner class PictureAndThumbnailTests {
            ...
            fun `posterImage is set`() {
                tempDirectory {
                    ...
                    // then
                    assertThat(result.picture).isEqualTo(URL("https://media.kitsu.io/anime/poster_images/42006/small.jpg?1564302504"))
                    assertThat(result.thumbnail).isEqualTo(URL("https://media.kitsu.io/anime/poster_images/42006/tiny.jpg?1564302504"))
                }
            }
        }
        ...
        inner class SynonymsTests {
            ...
            fun `all non main titles and the synonyms are combined`() {
                tempDirectory {
                    ...
                    val testKitsuConfig = object: MetaDataProviderConfig by MetaDataProviderTestConfig {
                        override fun buildAnimeLinkUrl(id: AnimeId): URL = KitsuConfig.buildAnimeLinkUrl(id)
                        override fun buildDataDownloadUrl(id: String): URL =
                            KitsuConfig.buildDataDownloadUrl(id)
        ...
        inner class RelationsTests {
            ...
            fun `no adaption, multiple relations`() {
                tempDirectory {
                    ...
                    assertThat(result.relatedAnime).containsExactly(
                        URL("https://kitsu.io/anime/10761"),
                        URL("https://kitsu.io/anime/12549"),
                        URL("https://kitsu.io/anime/13562"),
                        URL("https://kitsu.io/anime/7742"),
                        URL("https://kitsu.io/anime/7913"),
                        URL("https://kitsu.io/anime/8273")
                    )
                }
            }
            ...
            fun `has adaption, multiple relations`() {
                tempDirectory {
                    ...
                    // then
                    assertThat(result.relatedAnime).containsExactly(
                        URL("https://kitsu.io/anime/1759"),
                        URL("https://kitsu.io/anime/1921"),
                        URL("https://kitsu.io/anime/2634"),
                        URL("https://kitsu.io/anime/3700"),
                        URL("https://kitsu.io/anime/42535"),
                        URL("https://kitsu.io/anime/5518"),
                        URL("https://kitsu.io/anime/6791"),
                        URL("https://kitsu.io/anime/7627")
                    )
                }
            }
        ...
        inner class StatusTests {
            ...
            fun `'unreleased' is mapped to 'NOT_YET_AIRED'`() {
                tempDirectory {
                    ...
                    testResource("file_converter_tests/no_adaption_no_relations_default_file.json")
                        .copyTo(relationsDir.resolve("41450.${testKitsuConfig.fileSuffix()}"))
                    ...
                    testResource("file_converter_tests/no_tags_default_file.json")
                        .copyTo(tagsDir.resolve("41450.${testKitsuConfig.fileSuffix()}"))
            ...
            fun `'tba' is mapped to 'UNKNOWN'`() {
                tempDirectory {
                    ...
                    testResource("file_converter_tests/no_adaption_no_relations_default_file.json")
                        .copyTo(relationsDir.resolve("10023.${testKitsuConfig.fileSuffix()}"))

                    val tagsDir = tempDir.resolve("tags").createDirectory()

                    testResource("file_converter_tests/no_tags_default_file.json")
                        .copyTo(tagsDir.resolve("10023.${testKitsuConfig.fileSuffix()}"))
            ...
            inner class YearOfPremiereTests {
                ...
                fun `startDate is null`() {
                    tempDirectory {
                        ...
                        testResource("file_converter_tests/no_adaption_no_relations_default_file.json").copyTo(relationsDir.resolve("10023.${testKitsuConfig.fileSuffix()}"))
